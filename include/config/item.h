...
#define I_EXP_SHARE_FLAG        FLAG_SHARE_EXP  // If this flag is set, every Pokémon in the party will gain experience, regardless if they participated in the battle or not.
...
#define VAR_LAST_REPEL_LURE_USED    VAR_REPEL_LURE  // If this var has been assigned, last Repel/Lure used will be saved and the player will get prompted with the vanilla repel YES/NO option, unless I_REPEL_LURE_MENU is set to TRUE.
...
#define I_ORAS_DOWSING_FLAG         FLAG_DOWSING_MACHINE // Replace 0 with an unused flag to enable the Dowsing Machine mechanic from ORAS.
